...
**Version 0.1.0** Semgrep Engineering January 2026

> **Note:** This document is mainly for agents and LLMs to follow when maintaining, generating, or refactoring codebases with a focus on security best practices. Humans may also find it useful, but guidance here is optimized for automation and consistency by AI-assisted workflows.
...
**Insecure: vulnerable to command injection via subprocess**
...
**Secure: use array form without shell=True**
...
**Insecure: vulnerable child_process with user input**
...
**Insecure: ProcessBuilder with user input via shell**
...
**Secure: use ProcessBuilder with array arguments, no shell**
...
**Insecure: dangerous command with user input via stdin**
...
**Secure: use exec.Command with explicit arguments**
...
**Insecure: Shell methods with tainted input**
...
**Secure: use hardcoded or validated paths**
...
**Insecure: user input in response**
...
**Insecure: request data in HttpResponse**
...
**Insecure: writing request parameters directly**
...
**Insecure: writing user input to ResponseWriter**
...
**Secure: resolve and enforce boundary**
...
**Secure: sanitized with FilenameUtils**
...
**Insecure: Clean does not prevent traversal**
...
**Secure: prefix with "/" before Clean**
...
Best Practice: Prefer filepath.FromSlash(path.Clean("/"+strings.Trim(req.URL.Path, "/"))) or the SecureJoin function from github.com/cyphar/filepath-securejoin.

**References:**

**Insecure: vulnerable to path traversal/RFI**
...
**Insecure: using pickle with user input**
...
**Secure: use JSON or load from trusted file**
...
**Insecure: using insecure deserialization libraries**
...
**Secure: use JSON.parse for untrusted data**
...
**Insecure: using ObjectInputStream to deserialize untrusted data**
...
**Secure: use JSON or implement input validation**
...
**Insecure: using Marshal.load or YAML.load with user input**
...
**Secure: use safe options or trusted data**
...
**Insecure: using BinaryFormatter which is inherently insecure**
...
**Secure: use System.Text.Json or Newtonsoft with safe settings**
...
**Insecure: unserializing user-controlled data**
...
**Secure: use JSON or hardcoded data**
...
Code injection vulnerabilities occur when an attacker can insert and execute arbitrary code within the application. This includes direct code evaluation (eval, exec), reflection-based attacks, and dynamic method invocation. These vulnerabilities can lead to complete system compromise, data theft, and remote code execution.

**Insecure: Python - eval with user input**
...
**Secure: Python - avoid eval entirely, use safe alternatives**
...
**Insecure: JavaScript - eval with dynamic content**
...
**Secure: JavaScript - avoid eval, use safe alternatives**
...
**Insecure: Java - ScriptEngine injection**
...
**Secure: Java - static ScriptEngine evaluation**
...
**Insecure: PHP - code injection via eval/assert**
...
**Secure: PHP - avoid eval, use structured alternatives**
...
**Insecure: Python - hardcoded AWS credentials**
...
**Secure: Python - AWS credentials from environment**
...
**Insecure: JavaScript - hardcoded JWT secret**
...
**Secure: JavaScript - JWT secret from environment**
...
**Insecure: JavaScript - hardcoded express-jwt secret**
...
**Secure: JavaScript - express-jwt secret from environment**
...
**Insecure: Python Flask - hardcoded SECRET_KEY**
...
**Secure: Python Flask - SECRET_KEY from environment**
...
**Insecure: Python - empty password string**
...
**Secure: Python - password from secure source**
...
**Insecure: JavaScript - hardcoded Stripe token**
...
**Secure: JavaScript - Stripe token from environment**
...
**Insecure: Python - hardcoded GitHub token**
...
**Secure: Python - GitHub token from environment**
...
**Insecure: HTTP requests without TLS**
...
**Secure: HTTPS requests with TLS**
...
**Insecure: disabled TLS verification**
...
**Secure: TLS verification enabled**
...
**Insecure: disabled TLS verification via empty X509TrustManager**
...
**Secure — Option A: Use the JVM default trust manager (preferred):**
...
**Secure — Option B: Explicit SSLContext with default TrustManagerFactory (when custom configuration is needed):**
...
**Insecure: user input flows into URL host**
...
**Secure: fixed host, user data only in path**
...
**Secure: fixed host, user data in path**
...
**Insecure: user input in URL host**
...
**Insecure: user input in HTTP request**
...
**Insecure: JavaScript jsonwebtoken - decode without verify**
...
**Secure: JavaScript jsonwebtoken - use verify which returns decoded payload**
...
**Insecure: Python PyJWT - verify_signature disabled**
...
**Secure: Python PyJWT - verify_signature enabled**
...
**Insecure: Java auth0 java-jwt - decode without verify**
...
**Secure: Java auth0 java-jwt - verify before use**
...
**Insecure: using @csrf_exempt decorator**
...
**Secure: remove csrf_exempt decorator**
...
**Insecure: Express app without CSRF protection**
...
**Secure — Option A: csrf-csrf (Double-Submit Cookie pattern):**
...
**Secure — Option B: csrf-sync (Synchronizer Token pattern):**
...
**Insecure: explicitly disabling CSRF protection**
...
**Insecure: controller without protect_from_forgery**
...
**Secure: controller with protect_from_forgery**
...
**Insecure: C - strcat buffer overflow**
...
**Secure: C - use strcat_s with bounds checking**

```c
// Use strcat_s which performs bounds checking
```

**Insecure: C - strcpy buffer overflow**
...
**Secure: C - use strcpy_s with bounds checking**

```c
// Use strcpy_s which performs bounds checking
```

**Insecure: C - strtok modifies buffer**
...
**Insecure: C - scanf buffer overflow**
...
**Insecure: C - gets buffer overflow**
...
**Secure: C - use fgets or gets_s instead**
...
**Insecure: PHP - deprecated mcrypt functions**
...
**Secure: PHP - use Sodium or OpenSSL**
...
**Insecure: Python - tempfile.mktemp race condition**
...
**Secure: Python - use NamedTemporaryFile**
...
**Insecure: Go - unsafe package bypasses type safety**
...
**Secure — Option A (Rust - use safe standard library alternative, preferred):**
...
**Secure — Option B (Rust - minimally scoped unsafe block with SAFETY comment):**
...
**Insecure: OCaml - unsafe functions skip bounds checks**
...
**Secure: OCaml - use bounds-checked functions**
...
When using pull_request_target, the Action runs in the context of the target repository with access to all repository secrets. Checking out the incoming PR code while having access to secrets is dangerous because the workflow may inadvertently execute arbitrary code from the incoming PR.
...
**Insecure: vulnerable to script injection via PR title**
...
**Insecure: checking out PR code with pull_request_target**
...
**Insecure: checking out PR code with workflow_run**
...
**Secure: pinned to full commit SHA**
...
**Insecure: vulnerable ReDoS pattern**
...
**Insecure: non-literal RegExp with user input**
...
**Secure: hardcoded regex patterns**
...
**Insecure: incomplete string sanitization**
...
**Secure: use regex with global flag**
...
**Insecure: inefficient regex pattern**
...
**Insecure: vulnerable to race condition**
...
**Secure: use tempfile module or relative paths**
...
**Secure: use os.CreateTemp for atomic creation**
...
**INSECURE - Extra query to fetch related object:**
...
**SECURE - Use the foreign key directly:**
...
**INSECURE - Fetches all records into memory:**

```python
total = len(persons.all())
```

**SECURE - Count performed server-side:**
...
**INSECURE - Adding one at a time in a loop:**
...
**SECURE - Batch add all at once:**

```python
db.session.add_all(songs)
```

By declaring a styled component inside the render method, the model dynamically create a new component on every render. This forces React to discard and re-calculate that part of the DOM subtree on each render, leading to performance bottlenecks.

**INSECURE - Styled component declared inside function:**
...
**SECURE - Styled component declared at module level:**
...
**INSECURE - RegExp compiled on every iteration:**
...
**SECURE - Compile once, reuse in loop:**
...
**INSECURE - Full iteration to find one item:**

```javascript
const found = items.filter(x => x.id === targetId)[0];
```

**SECURE - Short-circuit on first match:**
