...
**Proactive mode** — During code writing or review, check automatically for vulnerabilities relevant to the language and patterns in use. Security checks do not depend on an explicit security request.

**Reactive mode** — For an explicit security request, use the categories below to locate the relevant rule file, then read it for detailed vulnerable and secure code examples.
