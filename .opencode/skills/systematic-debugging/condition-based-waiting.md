...
**Core principle:** Wait for the actual condition of interest, not a guess about how long the operation takes.
...
- Any arbitrary timeout requires a documented rationale
...
3. Include a comment explaining WHY.
